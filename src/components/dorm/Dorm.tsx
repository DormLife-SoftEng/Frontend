...
function Dorm() {
    ...
    const test: propsDorm = {
        ...
        location: {
            ...
            coordinate: { type: "Point", coordinates: [13.749943, 100.49131] },
        },
        utility: [
            {
                type: "parking",
        ...
        type: "house",
        description:
            "บ้านพักตากอากาศย่านพระนคร เพียง 0 ก้าวถึงถนน ที่จอดรถกว้างขวาง จอดตรงไหนก็ได้ที่คุณอยากจอด แถมฟรีพนักงานกันขโมยจากภาษีประชาชน",
        room: [
            {
