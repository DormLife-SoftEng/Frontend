...
function DormInfo(props: DormDetailProps) {
  ...
  return (
    <div
      style={{ textTransform: "capitalize", padding: "0% 2%", width: "100%" }}
    >
      ...
      {dorm.contact.website != null && <p>Website: {dorm.contact.website}</p>}
      <p>
        Map:
        <Googlemap
          coordinate={{
        ...
        {dorm.utility.map((util: Utilities, index: number) => {
          ...
          return (
            <span>
              ...
              {util.description != null && util.description.trim() != "" && (
