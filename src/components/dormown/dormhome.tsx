        ...
        <div>
            ...
            <div style={{ padding: "1% 4%" }}>
                <Row noGutters={true}>
                    ...
                    <Col xs={6} >
                        <Row noGutters={true} style={{background:"white",margin:"0% 2%"}}>
                        <Row noGutters={true} style={{marginBottom:"-30%"}}>
                            <DormDetail dorm={dorm}/>
                        </Row>
                        <Row noGutters={true} style={{ width:"100%",margin: "1% 2%" }}>
                            <Col xs ={6} style={{textAlign:"center"}}>
                                <Button variant="danger" style={{ textAlign: "left", color: "white" }}>
