  ...
  const suggestLists: propsSuggestItem[] = [
    {
      link: "#",
      src:
        "https://pix10.agoda.net/hotelImages/122/1220420/1220420_18051110480065351844.jpg?s=1024x768",
    },
    {
      link: "#",
      src:
        "https://pix10.agoda.net/hotelImages/460/4602558/4602558_18030706410062590812.jpg?s=1024x768",
    },
  ];
  return (
    <>
