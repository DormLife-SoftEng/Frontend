            ...
            >
              {authToken.role === "owner" ? (
                <img
                  ...
                  src={AllImages[authToken.avatar + 6]}
                />
              ) : (
                <img
                  style={{ marginBottom: "5px", width: "50px", height: "50px" }}
                  src={AllImages[authToken.avatar]}
                />
              )}
              <h3 style={{ display: "inline-block", margin: "10px 10px 0" }}>
                {authToken.name.firstName} {authToken.name.lastName}
              </h3>
            </div>
            <Button
              onClick={handleClick}
